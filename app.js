...
// मेननेट पर स्विच करने के लिए (भविष्य में)
function switchToMainnet() {
  // सिर्फ चेन ID बदलें
  walletConnectModal.updateChains(["eip155:56"]); // BSC मेननेट
  stakingContract = new web3.eth.Contract(contractABI, "MAINNET_CONTRACT_ADDRESS");
}
